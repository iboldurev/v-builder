...
class VBuilder {
  ...
  */
  ...
  static install (Vue, options = {}) {
    ...
    _Vue = Vue;
    const builder = new VBuilder(Object.assign({}, BUILDER_OPTIONS, options));
    ...
    Vue.component('v-builder', Vue.extend(Builder).extend(extension));
    Vue.component('v-renderer', Vue.extend(Renderer).extend(extension));
  }
